...
const Contact = () => {
  ...
  return (
    <div id="contact" className={styles.contactDiv}>
      ...
      <a href="https://goo.gl/maps/qLnHmH28aELjkCsf9" className={styles.contactLink}>
        <FontAwesomeIcon icon={icon({name:"house"})} />
        <p>Mississauga, ON</p>
      </a>
      <a href="https://www.linkedin.com/soojin-kim1" className={styles.contactLink}>
        <FontAwesomeIcon icon={icon({name:"linkedin", style:'brands'})} />
        <p>LinkedIn</p>
        <FontAwesomeIcon icon={icon({name:"arrow-up-right-from-square"})} />
      </a>
      <a href="https://github.com/skim2264" className={styles.contactLink}>
